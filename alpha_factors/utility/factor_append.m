...
%   此处显示详细说明
    ...
    C = outerjoin(code_map1,code_map2,'Keys',{'stk_codes'});
    ...
    append_data = join(append.data,C,'LeftKeys',{'stk_num'},'RightKeys',{'stk_num_code_map2'},'RightVariables',{'stk_num_code_map1'},'Typ2','left');
