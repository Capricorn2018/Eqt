...
cap_type = 'tot_cap';
market_cap( capital_folder, close_folder, stk_codes, output_folder, cap_type);
cap_type = 'float_cap';
market_cap( capital_folder, close_folder, stk_codes, output_folder, cap_type);
...
db_names = {'tot_shrhldr_eqy_excl_min_int','tot_non_cur_liab','monetary_cap','tot_assets','tot_cur_assets','tot_cur_liab'};
output_folder = 'D:/Projects/pit_data/mat/alpha_factors';
rpt_type = 'LR';
calc_ttm_lr(input_folder, stk_codes, db_names, output_folder, rpt_type);
