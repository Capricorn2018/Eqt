function   [index_self,index_membs,num_of_stks_index,index_dates] = sim_sec_index(sec_codes_lv3,l3codes,total_shr,data_satus,...
...
%%      
    for i = 1 : T
        ...
        idx_stk(~ismember(sec_codes_lv3(idx,:),l3codes)) = false;  % 排除行业
